...
-- Découvert à l'application (16 juillet 2026) : completed_at (déclarée dans
-- schema-seances-completed.sql) était absente de la prod — la migration
-- d'origine n'avait été appliquée que partiellement. Rattrapage idempotent :
