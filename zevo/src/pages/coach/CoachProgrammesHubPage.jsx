    ...
    <div className="p-4 md:p-6 max-w-2xl mx-auto animate-page-enter">
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        <button
          ...
          className="group relative overflow-hidden rounded-2xl border border-[var(--border-base)] bg-[var(--bg-card)] p-6 text-left transition-all hover:border-emerald-500/20 active:scale-[0.98]"
        >
          <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-emerald-500 via-emerald-300 to-transparent" />
          ...
          <div className="relative flex items-center gap-4">
            ...
            >
              <Apple size={26} className="text-emerald-500" />
            </div>
            <div className="flex-1 min-w-0">
            ...
            <div className="w-10 h-10 rounded-xl bg-[var(--bg-surface)] flex items-center justify-center shrink-0 group-hover:bg-emerald-500/10 transition-colors">
              <ChevronLeft size={18} className="text-[var(--text-muted)] rotate-180 group-hover:text-emerald-500 transition-colors" />
            </div>
          </div>
        </button>
      </div>
