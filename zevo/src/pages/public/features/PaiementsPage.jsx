...
function PaiementsMockup() {
  const transactions = [
    { name: 'Lucas Martin', amount: '89', date: '6 avr.', status: 'Payé', statusColor: '#22C55E' },
    { name: 'Emma Dubois', amount: '129', date: '5 avr.', status: 'Payé', statusColor: '#22C55E' },
    { name: 'Hugo Bernard', amount: '89', date: '4 avr.', status: 'Payé', statusColor: '#22C55E' },
    { name: 'Léa Moreau', amount: '59', date: '3 avr.', status: 'En attente', statusColor: '#F59E0B' },
    { name: 'Thomas Petit', amount: '129', date: '2 avr.', status: 'Payé', statusColor: '#22C55E' },
  ]

  const offers = [
    { name: 'Coaching Premium', price: '129', interval: '/mois', clients: 18 },
    { name: 'Suivi Standard', price: '89', interval: '/mois', clients: 24 },
    { name: 'Séance Découverte', price: '59', interval: 'unique', clients: 5 },
  ]
        ...
        <div className="rounded-xl bg-[#0C0C0C] p-5 md:p-7">
          ...
          <div className="rounded-xl border border-white/[0.06] bg-[#141414] p-4">
            <div className="flex items-center justify-between mb-3">
              <p className="text-[10px] font-semibold text-[#F5F5F3]/30 uppercase tracking-wider">Transactions récentes</p>
...
export default function PaiementsPage() {
  return (
    <FeaturePageLayout
      ...
      subtitle="Connecte Stripe en un clic, crée tes offres, encaisse automatiquement. L'argent arrive directement sur ton compte."
      stats={[
      ...
      features={[
        { icon: Zap, title: 'Stripe Connect', desc: "Connecte ton compte Stripe en un clic. Tes paiements arrivent directement sur ton compte, sans intermédiaire." },
        { icon: Receipt, title: 'Offres personnalisées', desc: "Crée des abonnements mensuels, des packs ou des séances uniques. Fixe tes prix, Zevo gère le reste." },
        ...
        { icon: BarChart3, title: 'Tableau de bord revenus', desc: "Visualise tes revenus en temps réel. MRR, churn, croissance — pilote ton business comme un pro." },
        { icon: BellRing, title: 'Relances impayés', desc: "Un paiement échoué ? Le système relance automatiquement. Récupère ton argent sans effort." },
        { icon: Clock, title: 'Historique transactions', desc: "Chaque paiement est tracé. Retrouve n'importe quelle transaction en quelques secondes." },
      ]}
      stepsTitle="Encaisse en 3 étapes"
      steps={[
        { title: 'Connecte Stripe', desc: "Un clic suffit. Ton compte Stripe est lié et prêt à recevoir des paiements en quelques secondes." },
        { title: 'Crée tes offres', desc: "Définis tes tarifs et tes formules. Abonnement mensuel, pack de séances, essai gratuit — toi qui décides." },
      ...
      ctaTitle="Prêt à simplifier tes paiements"
