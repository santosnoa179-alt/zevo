      ...
      <div className="absolute inset-0 flex items-center justify-center z-10">
        <div className="bg-[var(--bg-card)] border border-[var(--border-base)] rounded-2xl p-8 max-w-sm w-full text-center shadow-xl">
          ...
          <p className="text-[var(--text-muted)] text-sm mb-5">
            ...
            <span className="text-primary font-semibold capitalize">{minPlan}</span>.
            Passez au niveau supérieur pour débloquer cette fonctionnalité.
          </p>
          <button
            onClick={() => navigate('/coach/pricing')}
            className="inline-flex items-center gap-2 bg-primary text-white px-6 py-2.5 rounded-xl text-sm font-semibold hover:bg-[#e55e24] transition-colors"
          >
