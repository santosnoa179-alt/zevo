          ...
          <div className="bg-[var(--bg-card)] rounded-2xl p-8 space-y-6 animate-fade-in">
            ...
            <div className="space-y-3">
              <input
                ...
                placeholder="Prénom *"
                className="w-full bg-[var(--bg-base)] border border-[var(--border-base)] rounded-xl px-4 py-3 text-[var(--text-primary)] text-sm placeholder:text-[var(--text-muted)] focus:outline-none focus:ring-1 focus:ring-[var(--color-primary)]/50 transition-colors"
              />
              <input
                type="text"
                value={nom}
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[var(--bg-base)] border border-[var(--border-base)] rounded-xl pl-11 pr-4 py-3 text-[var(--text-primary)] text-sm placeholder:text-[var(--text-muted)] focus:outline-none focus:ring-1 focus:ring-[var(--color-primary)]/50 transition-colors"
                />
              </div>
            </div>
        ...
        {step === 4 && (
          <div className="bg-[var(--bg-card)] rounded-2xl p-8 space-y-6 animate-fade-in">
            ...
            <input
              ...
              className="w-full bg-[var(--bg-surface)] border border-[var(--border-base)] rounded-lg px-4 py-3 text-[var(--text-primary)] text-sm placeholder:text-[var(--text-muted)] focus:outline-none focus:border-[var(--color-primary)]/50 transition-colors"
            />
